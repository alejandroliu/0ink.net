...
#
# OVERRIDE COPY TO ADD no_change_rc FUNCTIONALITY
...
options:
  ...
  no_change_rc:
    description:
      - Use return code to signal no change
    version_add: "Local"
    type: int
notes:
...
def main():
    ...
    module = AnsibleModule(
        argument_spec=dict(
            ...
            no_change_rc = dict(type='int', required=False),
        ),
    ...
    no_change_rc = module.params['no_change_rc']
    ...
    if r['rc'] != 0:
      if no_change_rc is None:
        r['msg'] = 'non-zero return code'
        module.fail_json(**r)
      else:
        if r['rc'] == no_change_rc:
          r['changed'] = False
          r['rc'] = 0
        else:
          r['msg'] = 'non-zero return code'
