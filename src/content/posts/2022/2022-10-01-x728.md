...
- Check if the hardware is detected:
  - `sudo i2cdetect -y 1`
  - ![screenshot](https://raw.githubusercontent.com/alejandroliu/0ink.net/master/snippets/X728/imgs/X728x-i2c.png)
...
- [systemd unit file](https://github.com/alejandroliu/0ink.net/blob/master/snippets/X728/x728clock.service)
- [script](https://github.com/alejandroliu/0ink.net/blob/master/snippets/X728/scripts/clock.sh)
...
The code to do this can be found on [github](https://github.com/alejandroliu/0ink.net/tree/master/snippets/X728/src).
...
- [script](https://github.com/alejandroliu/0ink.net/blob/master/snippets/X728/gpio-poweroff)
...
- [systemd unit file](https://github.com/alejandroliu/0ink.net/blob/master/snippets/X728/x728ups.service)
- [upsmon.sh](https://github.com/alejandroliu/0ink.net/blob/master/snippets/X728/scripts/upsmon.sh)
...
For this, I have a script [haos-x728](https://github.com/alejandroliu/0ink.net/blob/master/snippets/X728/OTA/haos-x728.sh)
...
The [post-install handler](https://github.com/alejandroliu/0ink.net/blob/master/snippets/X728/OTA/post-install)
...
[post-install handler](https://github.com/alejandroliu/0ink.net/blob/master/snippets/X728/OTA/post-install)
are injected in the same way.

For the [post-install handler](https://github.com/alejandroliu/0ink.net/blob/master/snippets/X728/OTA/post-install)
...
[here](https://github.com/alejandroliu/0ink.net/blob/master/snippets/X728/OTA/x728rootfs.tar.gz).
